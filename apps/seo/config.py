...
class SEOConfig:
    ...
    # Default values
    DEFAULT_TITLE_SUFFIX = "errorweb.ir"
    DEFAULT_SEPARATOR = " | "
    ...
    DEFAULT_TWITTER_SITE = "@errorweb"
    
    # Site information
    SITE_NAME = "errorweb.ir"
    AUTHOR = "Ehsan Akbari"
    SITE_URL = getattr(settings, 'SITE_URL', 'https://errorweb.ir')
    ...
    COMMON_KEYWORDS = {
        'personal': [
            'errorweb', 'roneha', 'Ehsan Akbari', 'errorweb.ir',
            'errorweb blog', 'errorweb portfolio',
