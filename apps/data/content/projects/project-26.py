...
project_data = {
    ...
    "description": ['This slick platform lets you discover your Khodam color in a snap, no hassle.', 'Built with Django, it’s open to all for three months starting June 25, 2021.', 'Brings a modern, fun twist to mystical exploration with a smooth user experience.'],
    "images": {
    ...
    "github_url": "https://github.com/PeakPy/website-cek-khodam",
    "demo_url": "",
    "status": "completed",
    "created_at": None,
    "updated_at": datetime.strptime("2021-06-25T00:00:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
