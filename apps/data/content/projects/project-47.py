...
project_data = {
    ...
    "github_url": "https://github.com/PeakPy/Neural-Network-from-Scratch",
    "demo_url": "",
    "status": "completed",
    "created_at": datetime.strptime("2021-06-04T18:57:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
    "updated_at": datetime.strptime("2021-06-06T18:57:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
